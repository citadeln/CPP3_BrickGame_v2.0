/**
 * @file
 * @brief Заголовочный файл с овновными типами.
 */
...
typedef enum {
  ...
  COLLIDE,  ///< 4 - проверка заполненных линий и подсчет очков
  PAUSE,    ///< 5 - пауза
  GAMEOVER,   ///< 6 - gamveover
...
typedef enum {
  ...
  ERR, ///< Специальная константа для ошибки
} UserAction_t;
...
typedef struct {
  ...
  int score;       ///< текущее кол-во очков
  int high_score;  ///< рекордное кол-во очков
